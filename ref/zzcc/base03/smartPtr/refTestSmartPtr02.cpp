...
int test_shared_ptr4()
{
	...
	sharPtr = std::shared_ptr<MyInt>(new MyInt(2011));//  Hello: 2011 Good Bye: 1998 Good Bye: 2011
...
int test_shared_ptr5()
{
	...
	std::cout << "Deleted " << IntDeleter().count << " int values." << std::endl; //2
	std::cout << "Deleted " << DoubleDeleter().count << " double value." << std::endl; //1
	std::cout << "Deleted " << MyIntDeleter().count << " MyInt value." << std::endl; //1
